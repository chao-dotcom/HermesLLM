"""Generate preference dataset using AI."""
...
from hermes.core import PreferenceDataset
from hermes.core.enums import DataCategory
from hermes.core.prompts import GenerateDatasetSamplesPrompt
from hermes.datasets.generators import PreferenceDatasetGenerator
...
def generate_preference_dataset(
    ...
    """
    Generate preference dataset using LLM.
    ...
    """
    logger.info(f"Generating preference dataset (mock={mock})")
