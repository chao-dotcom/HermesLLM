"""Direct Preference Optimization training step."""
...
from hermes.training.advanced import TrainingConfig, DPOTrainer, DPOConfig
...
def train_dpo(
    ...
    """
    Run Direct Preference Optimization training with LoRA.
    ...
    Returns:
        Training metrics
    """
    logger.info("Starting DPO training step...")
    ...
    if config is None:
        ...
        # Update DPO config
        config.dpo = DPOConfig(beta=beta)
    ...
    logger.info(f"DPO training completed with metrics: {metrics}")
